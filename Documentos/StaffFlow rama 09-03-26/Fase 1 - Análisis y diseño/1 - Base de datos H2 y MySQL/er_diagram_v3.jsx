...
const NEW_COL   = "#E65100";

// ─── entity box component ─────────────────────────────────────────────────────
function Box({ title, c, fields, notes, style }) {
  return (
    <div style={{
...
export default function ERDiagram() {
  ...
  const P = {
    ...
    fich  : { left:40,  top:590 },
    pau   : { left:385, top:590 },
    sal   : { left:750, top:590 },
  };
    ...
    <div style={{ background:"#F8FAFC", minHeight:"100vh", padding:"22px 24px",
      ...
      <div style={{ textAlign:"center", marginBottom:18 }}>
        <div style={{ fontSize:20, fontWeight:800, color:"#1B3A5C", letterSpacing:-.5 }}>
          Diagrama Entidad-Relación — StaffFlow v3.0
        </div>
      ...
      <div style={{ position:"relative", width:W, height:H, margin:"0 auto" }}>
        ...
        <svg style={{ position:"absolute", top:0, left:0, width:W, height:H, pointerEvents:"none" }}>
          ...
          <Arrow x1={308} y1={338} x2={385} y2={338} color="#1A6B4A"/>
          <Label x={310} y={331} text="1" bold color="#1A6B4A"/>
          <Label x={330} y={331} text="1:1" bold color="#1A6B4A"/>
          <Label x={367} y={331} text="1" bold color="#1A6B4A"/>

          {/* empleados 1:N planificacion */}
          <Arrow x1={652} y1={338} x2={750} y2={338} color="#7B1FA2"/>
          <Label x={655} y={331} text="1" bold color="#7B1FA2"/>
          <Label x={675} y={331} text="1:N" bold color="#7B1FA2"/>
          <Label x={853} y={310} text="N" bold color="#7B1FA2"/>

          {/* empleados 1:N fichajes */}
          <Arrow x1={510} y1={490} x2={175} y2={590} color="#B71C1C"/>
          <Label x={470} y={510} text="1:N" bold color="#B71C1C"/>
          <Label x={118} y={585} text="N" bold color="#B71C1C"/>

          {/* empleados 1:N pausas */}
          <Arrow x1={518} y1={490} x2={518} y2={590} color="#E65100"/>
          <Label x={523} y={540} text="1:N" bold color="#E65100"/>
          <Label x={523} y={585} text="N" bold color="#E65100"/>

          {/* empleados 1:N saldos */}
          <Arrow x1={526} y1={490} x2={870} y2={590} color="#00695C"/>
          <Label x={620} y={515} text="1:N" bold color="#00695C"/>
          <Label x={873} y={585} text="N" bold color="#00695C"/>

          {/* audit dashed: usuarios → fichajes */}
          <Arrow x1={175} y1={460} x2={160} y2={590} dashed color={AUDIT_COL}/>
          {/* audit dashed: usuarios → pausas */}
          <Arrow x1={200} y1={460} x2={500} y2={590} dashed color={AUDIT_COL}/>
          {/* audit dashed: usuarios → planificacion */}
          <Arrow x1={270} y1={322} x2={750} y2={352} dashed color={AUDIT_COL}/>

          {/* 1 label at bottom of empleados */}
          <Label x={500} y={487} text="1" bold color="#555"/>
          <Label x={530} y={487} text="1" bold color="#555"/>
        </svg>
        ...
        <Box title="empleados" c={C.empleados} style={P.emp}
          fields={[
            ...
            {          label:"categoria  [OPERARIO|ADMINISTRATIVO" },
            {          label:"   TECNICO|ENCARGADO|OTRO]" },
        ...
        <Box title="planificacion_ausencias" c={C.planificacion} style={P.plan}
          fields={[
            ...
            {             label:"fecha  DATE" },
            {             label:"tipo_ausencia  TipoAusencia:" },
            {             label:"  FESTIVO_NACIONAL | FESTIVO_LOCAL" },
            {             label:"  VACACIONES | ASUNTO_PROPIO" },
            {             label:"  PERMISO_RETRIBUIDO" },
            {             label:"  DIA_LIBRE_COMPENSATORIO" },
        ...
        <Box title="fichajes" c={C.fichajes} style={P.fich}
          fields={[
            ...
            {             label:"fecha  DATE" },
            {             label:"tipo  TipoFichaje:" },
            {             label:"  NORMAL | FESTIVO_NACIONAL" },
            {             label:"  FESTIVO_LOCAL | VACACIONES" },
            {             label:"  ASUNTO_PROPIO | PERMISO_RETRIBUIDO" },
            {             label:"  BAJA_MEDICA" },
            {             label:"  DIA_LIBRE_COMPENSATORIO" },
            {             label:"  AUSENCIA_INJUSTIFICADA" },
        ...
        <Box title="pausas" c={C.pausas} style={P.pau}
          fields={[
            ...
            {             label:"tipo_pausa  TipoPausa:" },
            {             label:"  COMIDA | DESCANSO" },
            {             label:"  AUSENCIA_RETRIBUIDA | OTROS" },
            { audit:true, label:"FK usuario_id → usuarios  (auditoría)" },
          ]}
          notes={[
            { idx:true, text:"IDX: (empleado_id, fecha)*" },
            {           text:"AUSENCIA_RETRIBUIDA no descuenta jornada" },
          ]}
        />
        ...
        <Box title="saldos_anuales" c={C.saldos} style={P.sal}
          fields={[
            ...
            {          label:"dias_asuntos_propios_pendientes_anterior  INT" },
            {          label:"dias_asuntos_propios_derecho  INT" },
            {          label:"dias_asuntos_propios_consumidos  INT" },
            {          label:"dias_asuntos_propios_disponibles  INT" },
      ...
      <div style={{
        ...
        Los campos <span style={{color:NEW_COL,fontWeight:600}}>reset_token</span> y{" "}
        <span style={{color:NEW_COL,fontWeight:600}}>reset_token_expiry</span> son NULL en condiciones normales;
