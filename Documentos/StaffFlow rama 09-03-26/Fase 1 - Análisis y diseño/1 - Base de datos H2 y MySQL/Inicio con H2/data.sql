...
-- Versión: v3 (22/03/2026)
-- Cambios respecto a v2:
--   - Ana 19/03: fichaje cambiado de AUSENCIA_INJUSTIFICADA a PERMISO_RETRIBUIDO.
--     Permite verificar horas efectivas calculadas en PDF para ese tipo.
--   - Planificacion_ausencias de Ana 19/03 añadida para coherencia.
--   - Comentarios actualizados (intervenciones manuales Ana 19/03).
...
-- Ana 19/03: PERMISO_RETRIBUIDO (v3). Carlos 31/03: AUSENCIA_INJUSTIFICADA.
--
...
--   Ana 19/03: permiso retribuido aprobado por encargado (v3).
--
...
INSERT INTO fichajes (empleado_id, fecha, tipo, hora_entrada, hora_salida,
    total_pausas_minutos, jornada_efectiva_minutos, usuario_id, observaciones, fecha_creacion)
-- 19/03 jue — PERMISO_RETRIBUIDO (v3 — antes AUSENCIA_INJUSTIFICADA)
VALUES (1, '2026-03-19', 'PERMISO_RETRIBUIDO',
    NULL, NULL, 0, 0, 2, 'Permiso retribuido por gestión personal. Aprobado por encargado.', '2026-03-19 00:01:00');
...
-- 19/03 — PERMISO_RETRIBUIDO planificado (coherente con fichaje directo, v3)
INSERT INTO planificacion_ausencias (empleado_id, fecha, tipo_ausencia, procesado,
    usuario_id, observaciones, fecha_creacion)
VALUES (1, '2026-03-19', 'PERMISO_RETRIBUIDO', TRUE,
    2, 'Permiso retribuido por gestión personal. Aprobado por encargado.', '2026-03-18 17:00:00');
