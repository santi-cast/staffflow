...
public class SaldoService {
     ...
     * Recalcula desde el primer fichaje del año hasta hoy iterando todos
     * los fichajes del empleado en ese año. La operacion es idempotente:
     * ejecutarla varias veces produce el mismo resultado porque parte
     * siempre de cero y suma todos los fichajes del año.
     * Util para corregir inconsistencias tras modificar fichajes retroactivos.</p>
     *
     ...
     *
     * <p>Se usa en el patron findOrCreate de E40 (recalcular) cuando no
     * existe aun el registro para ese año. Los valores de derecho se
