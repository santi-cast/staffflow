...
- Datos de saldo fuera de rango contractual (`SaldoService.obtenerMiSaldo`, año futuro o anterior al alta del empleado) → `NotFoundException` (404): no puede existir saldo para ese año, contrato uniforme con el 404 del registro no calculable
...
- **Commits**: `48c5b9f` (feat), `648c5fa` (refactor)
