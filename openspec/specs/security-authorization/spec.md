...
- **Commits**: `d95c677` (feat @EnableMethodSecurity + @PreAuthorize audit), `1e0165d` (deuda colateral)
- **Canonical since**: 2026-05-09
- **Verified**: 6/6 scenarios PASS (smoke matrix 35/35 OK)
- **Note**: SecurityConfig bajó de 56 a 53 reglas URL durante la auditoría (Block 5 colateral).
