...
| DEBT-02 | E52/E53 tienen numeración duplicada con PresenciaController (E52→E55 resuelto para las caps afectadas; quedan duplicados residuales). Requiere change `endpoints-numbering-sanity`. | Engram #276 | Próximo ciclo SDD | PENDIENTE |
